        ...
        <div class="card card-info">
            <div class="card-header">
                <div class="card-tools pull-right">
                    <a href="{{route('huesped_index')}}" class="btn btn-block btn-info btn-sm">
                        <i class="fa fa-fw fa-reply-all"></i> Volver
                    </a>
                </div>
            </div>
            <form action="{{route('huesped_actualizar', ['id' => $datas->id])}}" id="form-general" class="form-horizontal" method="POST" autocomplete="off">
                @csrf
                @method("put")
                <div class="card-body">
